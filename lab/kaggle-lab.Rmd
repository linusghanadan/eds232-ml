...
tree_spec <- boost_tree(learn_rate = best_lr$learn_rate, # use optimized learning rate from previous step
                        ...
                        loss_reduction = tune(), # tune loss reduction (number of iterations without improvement before stopping)
                        mode = "regression",
                        engine = "xgboost"
)
...
stochastic_spec <- boost_tree(learn_rate = best_lr$learn_rate, # use optimized learning rate
                              ...
                              loss_reduction = best_tree$loss_reduction, # use optimized loss reduction (number of iterations without improvement before stopping)
