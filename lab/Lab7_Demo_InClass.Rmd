...
# For a true 'tidy' format, we'd typically melt the matrix into a long format. However, this isn't directly supported for dist objects.
# Instead, we'll proceed to hierarchical clustering.
