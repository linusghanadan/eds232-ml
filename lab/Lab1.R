...
pumpkins %>% 
  ggplot() +
  geom_point(aes(x = day, y = price), color = "orange4") +
  labs(title = "Market for pumpkins", x = "Day of year", y = "Price") +
  theme_bw()
...
new_pumpkins %>% 
  ...
  geom_point(size = 1.6, color = "orange4") +
  labs(title = "Market for pumpkins", x = "Day of year", y = "Price per bushel")
...
new_pumpkins %>%
  ...
  labs(title = "Market for pumpkins", x = "Month of year", y = "Mean price per bushel")
...
## -----------------------------------------------------------------------------
# Total number of cities represented in the data set
...
## -----------------------------------------------------------------------------
# Save 'pumpkins_train' as an RDS file
saveRDS(pumpkins_train, file = "~/Documents/MEDS/eds232-ml-code/eds232-ml-labs/pumpkins_train.rds")
